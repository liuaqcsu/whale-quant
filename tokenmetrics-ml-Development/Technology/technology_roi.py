...
def get_technology_accuracy(weights, max_score, tech):
    '''Function where you pass weights, max score and Technology data to calculate final score and returns the accuracy to find
...
if '__main__' == __name__:
    ...
    res.to_csv('/home/tokenmetrics/data/technology/New_roi.csv')
    x.to_csv('/home/tokenmetrics/data/technology/Old_roi.csv')
    pd.DataFrame([pd.Series(tech['question_number'].unique()).sort_values().tolist(), w]).to_csv('/home/tokenmetrics/data/technology/weights_roi.csv') 
    new_grade[['Coin','Score']].to_csv('/home/tokenmetrics/data/technology/new_grade_roi.csv')
    ...
    y.to_csv('/home/tokenmetrics/data/technology/alpha_roi_roi.csv')