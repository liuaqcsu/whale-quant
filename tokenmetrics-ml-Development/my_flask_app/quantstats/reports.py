...
def html(returns, benchmark=None, rf=0.,c1='',c2='BTC',
    ...
    mtrx.to_csv('temp/'+'data_key_performance_metrics.csv')
    ...
    if benchmark is not None:
        ...
        yoy.index.name = 'Year'
        yoy.to_csv('temp/'+'data_return_vs_benchmark.csv')
        ...
        yoy.index.name = 'Year'
        mtrx.to_csv('temp/'+'data_return.csv')
    ...
    yoy.to_csv('temp/'+'data_worst_drawdowns.csv')
