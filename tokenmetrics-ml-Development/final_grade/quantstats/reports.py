...
def html(returns, benchmark=None, rf=0.,c1='',c2='BTC',
         grayscale=False, title='',
    ...
    mtrx = metrics(returns=returns, benchmark=benchmark,
                   rf=rf, display=False, mode='full',c1=c1,c2=c2,
                   sep=True, internal="True",
                   compounded=compounded)[2:]
    mtrx.index.name = 'Metric'
    mtrx.to_csv('/home/tokenmetrics/data/quant/temp/'+'data_key_performance_metrics.csv')
    ...
    if benchmark is not None:
        ...
        yoy.columns = [c2, c1, 'Multiplier', 'Won']
        yoy.index.name = 'Year'
        yoy.to_csv('/home/tokenmetrics/data/quant/temp/'+'data_return_vs_benchmark.csv')
        ...
        yoy.index.name = 'Year'
        mtrx.to_csv('/home/tokenmetrics/data/quant/temp/'+'data_return.csv')
    ...
    yoy.to_csv('/home/tokenmetrics/data/quant/temp/'+'data_worst_drawdowns.csv')
    tpl = tpl.replace('{{dd_info}}', _html_table(dd_info, False))

    # plots
    figfile = _utils._file_stream()
    _plots.returns(returns, benchmark, grayscale=grayscale,
                   figsize=(8, 5), subtitle=False,c1=c1,c2=c2,
    ...
    _plots.log_returns(returns, benchmark, grayscale=grayscale,
                       figsize=(8, 4), subtitle=False,c1=c1,c2=c2,
                       savefig={'fname': figfile, 'format': 'svg'},
                       show=False, ylabel=False, cumulative=compounded)
    ...
    if benchmark is not None:
        figfile = _utils._file_stream()
        _plots.returns(returns, benchmark, match_volatility=True,c1=c1,c2=c2,
    ...
    figfile = _utils._file_stream()
    _plots.yearly_returns(returns, benchmark, grayscale=grayscale,c1=c1,c2=c2,
    ...
    _plots.daily_returns(returns, grayscale=grayscale,
                         figsize=(8, 3), subtitle=False,#c1=c1,c2=c2,
                         savefig={'fname': figfile, 'format': 'svg'},
    ...
    figfile = _utils._file_stream()
    _plots.rolling_sortino(returns, grayscale=grayscale,c1=c1,c2=c2,
    ...
    figfile = _utils._file_stream()
    _plots.drawdowns_periods(returns, grayscale=grayscale,#c1=c1,c2=c2,
                             figsize=(8, 4), subtitle=False,
                             savefig={'fname': figfile, 'format': 'svg'},
                             show=False, ylabel=False, compounded=compounded)
    ...
    figfile = _utils._file_stream()
    _plots.drawdown(returns, grayscale=grayscale,#c1=c1,c2=c2,
                    figsize=(8, 3), subtitle=False,
                    savefig={'fname': figfile, 'format': 'svg'},
                    show=False, ylabel=False)
    ...
    figfile = _utils._file_stream()
    _plots.monthly_heatmap(returns, grayscale=grayscale,#c1=c1,c2=c2,
    ...
    figfile = _utils._file_stream()
    _plots.distribution(returns, grayscale=grayscale,#c1=c1,c2=c2,
                        figsize=(8, 4), subtitle=False,
                        savefig={'fname': figfile, 'format': 'svg'},
                        show=False, ylabel=False, compounded=compounded)
...
def metrics(returns, benchmark=None, rf=0., display=True,c1='',c2='BTC',
    ...
    metrics['Risk-Free Rate %'] = tag[-10].text #_pd.Series(s_rf)
