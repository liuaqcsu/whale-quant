...
if '__main__' == __name__:
    ...
    res.to_csv('/home/tokenmetrics/data/fundamental/New.csv')
    x.to_csv('/home/tokenmetrics/data/fundamental/Old.csv') 
    pd.DataFrame([pd.Series(tech['question_number'].unique()).sort_values().tolist(), w]).to_csv('/home/tokenmetrics/data/fundamental/weights.csv', index=False)
    new_grade[['Coin','Score']].to_csv('/home/tokenmetrics/data/fundamental/new_grade.csv')
    ...
    y.to_csv('/home/tokenmetrics/data/fundamental/alpha_roi.csv')